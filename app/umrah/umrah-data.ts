...
export const journeyItems = [
  ...
  { num: '04', icon: 'star', title: '5-Star Accommodation', desc: '5 nights at Dar Al-Hijra Intercontinental in Madinah and 3 nights at Jumeirah Jabal Omar in Makkah, with daily breakfast included.' },
];
